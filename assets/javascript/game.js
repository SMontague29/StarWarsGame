$(document).ready(function() {
	...
	function addAttClickListeners() {
		...
		$("#attack").on("click", function() {
			...
			if (gameOn) {
				...
				var selectedCharacter = $("#selected-character #character-placeholder .ui-content").html();
				var selectedEnemy = $("#fight-section #selected-enemy .ui-content .characterName").html();
				var selectedCharacterHealthPoints = $("#selected-character #character-placeholder .ui-content .characterHealth").html();
				var selectedCharacterAttackPower = $("#selected-character #character-placeholder .ui-content").attr("data-attackPower");
				var selectedEnemyHealthPoints = $("#fight-section #selected-enemy .ui-content .characterHealth").html();
				var selectedEnemyCounterAttackPoints = $("#fight-section #selected-enemy .ui-content").attr("data-counterAttackPower");
    ...
    function characterAttacks(selectedCharacterHealthPoints, selectedEnemyCounterAttackPoints, selectedCharacterAttackPower, selectedEnemy) {
		...
		$("#selected-character #character-placeholder .ui-content .characterHealth").html(selectedCharacterHealthPoints);
    ...
    function enemyAttacksBack(selectedEnemyHealthPoints, selectedCharacterAttackPower) {
    	...
    	$("#fight-section #selected-enemy .ui-content .characterHealth").html(selectedEnemyHealthPoints);
    	...
    	$("#selected-character #character-placeholder .ui-content").attr("data-attackPower", updatedCharacterAttackPower);
    	enemyDefeated = false;
    }
	...
	function enemyLost(selectedEnemyHealthPoints, selectedCharacterAttackPower, selectedEnemy) {
		...
		var currentEnemy = $("#fight-section #selected-enemy .ui-content");
